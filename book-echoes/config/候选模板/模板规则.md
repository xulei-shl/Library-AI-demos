...
<!-- ✅ CSS背景图片 -->
<div style="background-image: url('pic/b.png');"></div>
...
<body>
    ...
    <div class="library-card">
        ...
        <div class="top-section">
            ...
            <img src="pic/cover.jpg" alt="Book Cover" class="book-cover">
        </div>
        
        <!-- 底部装饰区域（可选） -->
        <div class="bottom-section">
            <img src="pic/b.png" alt="Background" style="width: 100%; height: 100%; object-fit: cover;">
        </div>
    </div>
</body>
</html>
...
1. **禁止**修改截图逻辑代码（`html_to_image_converter.py`）
2. **禁止**使用绝对路径或网络图片路径
...
- **点阵模板**：`config/点阵.html` - 完整的模板示例
- **借书卡模板**：`config/library_card_template.html` - 垂直卡片示例
- **截图配置**：`config/setting.yaml` - 截图参数配置
- **截图转换器**：`src/core/card_generator/html_to_image_converter.py` - 截图逻辑代码
