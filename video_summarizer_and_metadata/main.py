...
def process_folder(folder_path, template_key):
    # print(f"\n-------------------开始处理视频文件...----------------------\n")
    ...
    print(f"\n-------------------开始文本总结...----------------------\n")
    get_insights_in_folder(folder_path, llm_configs, template_key)
    print(f"\n-------------------文本总结完成----------------------\n")

    print(f"\n-------------------开始小红书文案...----------------------\n")
    social_media_writer(folder_path, llm_configs, template_key)
    print(f"\n-------------------文案撰写完成----------------------\n")
...
if __name__ == '__main__':
    ...
    if os.path.isdir(folder_path):
        process_folder(folder_path, template_key="summarization1")
    else:
        print("无效的文件夹路径")