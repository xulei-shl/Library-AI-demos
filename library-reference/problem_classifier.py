...
def classify_problem(user_input, llm_configs):
    ...
    classify_ruler = """
        ...
        馆藏图书报刊查询 - 当有人询问有关某本图书、报纸或其他、或关于某个主题的图书、或某个人写的图书馆等馆藏图书信息时使用。
        数据库咨询 - 当有人询问关于数据库的使用方法、特定主题或问题相关的数据库选择、开放获取等信息时使用。
        电子书查询 - 当有人询问有关电子书查询、某个主题或问题可以使用哪些电子书等信息时使用。
        学术文献查询 - 当有人询问有关期刊论文使用、某个主题或问题可以使用哪些期刊论文等信息时使用。
        近代文献与古籍文献咨询 - 当有人询问有关近代文献、古籍文献使用、某个主题或问题可以使用哪些近代文献、古籍文献等信息时使用。
        展览讲座咨询 - 当有人询问有关图书馆展览讲座的信息时使用。
        专业服务咨询 - 当有人询问文献传递、原书外借、资料查证、收录引证、检索咨询、翻译服务、科技查新、情报定制等图情业务的服务时使用。
        读者投诉 - 当有人抱怨图书馆服务等事情时使用。                
        其他 - 当不属于上述任何类别时使用
    """
